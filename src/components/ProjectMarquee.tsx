            ...
            >
                {[...repos, ...repos].map((repo, index) => (
                    <Link
                        ...
                        href={repo.html_url}
                        target="_blank"
                        className="group relative flex flex-col justify-between w-[450px] h-[280px] p-8 rounded-3xl bg-gradient-to-b from-white/10 to-white/5 border border-white/10 backdrop-blur-md hover:from-white/15 hover:to-white/10 transition-all duration-300 hover:border-blue-500/50 hover:shadow-[0_10px_40px_-10px_rgba(59,130,246,0.3)] hover:-translate-y-2 flex-shrink-0"
                    >
                        <div>
                            ...
                            <h3 className="text-2xl font-bold text-white mb-3 tracking-tight group-hover:text-blue-200 transition-colors truncate">
                                {repo.name}
                            </h3>

                            <p className="text-base text-gray-400 line-clamp-3 mb-4 leading-relaxed">
