...
const socials = [
    ...
    },
    {
        ...
        icon: (
            <svg role="img" viewBox="0 0 24 24" width="32" height="32" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><title>GeeksforGeeks</title><path d="M12.002 0C5.374 0 0 5.373 0 12c0 6.628 5.374 12 12.002 12 6.626 0 11.998-5.372 11.998-12 0-6.627-5.372-12-11.998-12zm5.72 17.58c-.52.27-1.14.27-1.66.01-.15-.08-.28-.2-.38-.34-.1-.14-.15-.31-.15-.48v-2.12c0-.51-.2-.99-.56-1.35-.36-.36-.84-.56-1.35-.56h-2.12c-.51 0-.99.2-1.35.56-.36.36-.56.84-.56 1.35v2.12c0 .51-.2.99-.56 1.35-.36.36-.84.56-1.35.56-.51 0-.99-.2-1.35-.56-.36-.36-.56-.84-.56-1.35v-2.12c0-.51-.2-.99-.56-1.35-.36-.36-.84-.56-1.35-.56-.51 0-.99-.2-1.35-.56-.36-.36-.56-.84-.56-1.35v-2.12c0-.51.2-.99.56-1.35.36-.36.84-.56 1.35-.56.51 0 .99.2 1.35.56.36.36.56.84.56 1.35v2.12c0 .51.2.99.56 1.35.36.36.84.56 1.35.56h2.12c.51 0 .99-.2 1.35-.56.36-.36.56-.84.56-1.35v-2.12c0-.51.2-.99.56-1.35.36-.36.84-.56 1.35-.56.51 0 .99.2 1.35.56.36.36.56.84.56 1.35v2.12c0 .51.2.99.56 1.35.36.36.84.56 1.35.56.51 0 .99.2 1.35.56.36.36.56.84.56 1.35v2.12c0 .17-.05.34-.15.48-.1.14-.23.26-.38.34z" /></svg>
        ),
    },
    {
        id: "linkedin",
